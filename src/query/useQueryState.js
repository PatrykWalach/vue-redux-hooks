 ...
 * @returns {UseQueryState<D>}
 */
export const createUseQueryState = (endpoint) => (arg, { skip = false } = {}) => {
    ...
    return {
        ...
        isSuccess: computed(() => result.value.isSuccess || (isFetching.value && hasData.value)),
